...
if (isset($_GET['rech'])) {
    ...
    WHERE materiel.Id_mat LIKE '%$valeur%' OR Des_mat LIKE '%$valeur%' OR Prix_mat LIKE'%$valeur%' OR Type_mat LIKE'%$valeur%' OR Num_speciale LIKE'%$valeur%' OR Validation_mat LIKE'%$valeur%'";
